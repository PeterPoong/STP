...
<head>
    ...
    <title>New Applicant For From {{ $institute_name }}</title>
    <style>
        .button {
    ...
    <table style="width: 100%; max-width: 600px; margin: 0 auto; border-collapse: collapse;">
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #f8f8f8;">
                <h1 style="margin: 0; color: #333;">New Applicant For From {{ $institute_name }}</h1>
            </td>
        </tr>
        <tr>
            <td style="padding: 20px; background-color: #ffffff;">
                ...
                <p>
                    ...
                    <p><a href="https://studypal.my/adminLogin" class="button" target="_blank">View Application Details</a></p>
